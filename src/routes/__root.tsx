...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CineFlix — Catálogo de Filmes" },
      {
        name: "description",
        content:
          "Descubra filmes populares, em cartaz e lançamentos. Favorite, comente e compartilhe sua lista no CineFlix.",
      },
      { property: "og:title", content: "CineFlix — Catálogo de Filmes" },
      {
        property: "og:description",
        content: "Catálogo de filmes com dados do TMDB: favoritos, comentários e trailers.",
      },
